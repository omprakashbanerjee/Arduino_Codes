...
Serial.println("\r\n");
Serial.println(hall_y);
Serial.println(hall_b);
Serial.println(hall_g);
...
sensorValue1 = sensorValue1/5; // map tuning knob to the range of the analog out: outputValue1 = map(sensorValue1, 0, 1023, -90, 90); //PID CALC Cn = outputValue1; //MOTOR DRIVE WheelDirection dir; if (Cn > 0)
int dir = DIR_FORWARD;
